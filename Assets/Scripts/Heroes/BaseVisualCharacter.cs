...
namespace Heroes
{
    ...
    {
        [Header("Что за герой")] [SerializeField]
        private Hero _who;


        [Header("Звуки")] private bool playAnimalSounds = true;
        [SerializeField] private Vector3 soundOffset = Vector3.zero;

        [Header("Логирование")] [SerializeField]
        private bool debugAI = true;

        [Header("Маркировка цели для отладки")] [SerializeField]
        ...
        [Header("Анимация босса")] [SerializeField]
        public AnimationReferenceAsset laughterAnimation;
        ...
        public void PlayAppear()
        {
            ...
            else if (_who == Hero.GobArcher || _who == Hero.OrcWar)
            {
        ...
        public void Attack()
        {
            ...
            else if (_who == Hero.Skeleton || _who == Hero.OrcWar)
            {
                PlaySound(SoundId.SkeletonAttack);
            }
            else if (_who == Hero.Lich)
